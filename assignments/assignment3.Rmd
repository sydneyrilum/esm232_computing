...
* car D mass 5000 kg area 10 m^2^   ## added super light car!
...
Lets use our **autopower** function to estimate a distribution of power 
...
ggsave(filename = "power_estimates.png", height = 10, width = 4)
